...
form.addEventListener("submit", function(e){
    ...
    console.log(cashDiscountPrice.value);
    ...
    //1.3現金折抵
    parseCashDiscount = parseInt(cashDiscountPrice.value);
    console.log(parseCashDiscount);  
    ...
    if(parseOriginPrice * parseDiscount >= 100){
        discountAll = discountAll + parseCashDiscount;
    }
